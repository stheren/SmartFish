...
class SpendYourTime private constructor() : StackPane()
{
    companion object
    {
        ...
        const val STYLE_INPUT = "-fx-background-color: #000000, -fx-discord-blue; -fx-background-insets: 0, 1 1 1 1 ; -fx-background-radius: 0px; -fx-text-fill: #FFFFFF;"
    }
    ...
    fun popup(title: String, body: Pane, color: String, action: (() -> Boolean)?)
    {
        Platform.runLater {
            ...
            alert.style   = "-fx-border-color: $color; -fx-border-width: 2px; -fx-background-color: #3c3f41; -fx-background-radius: 5px; -fx-border-radius: 5px; -fx-padding: 5px;"
            ...
            alert.children.add(BorderPane().apply {
                ...
                right = Button("").apply {
                    style = "-fx-background-color: Transparent; -fx-border-color: $color; -fx-border-radius: 100; -fx-border-width: 2; -fx-background-radius: 100;"
                    ...
                    onMouseEntered = EventHandler {
                        style = "-fx-background-color: $color; -fx-border-color: $color; -fx-border-radius: 100; -fx-border-width: 2; -fx-background-radius: 100;"
                    }
            ...
            if (action != null)
            {
                alert.children.add(HBox().apply {
                    ...
                    children.add(Button("Ok").apply {
                        style = "-fx-background-color: TRANSPARENT; -fx-border-color: $color; -fx-border-radius: 100; -fx-border-width: 2; -fx-background-radius: 100; -fx-text-fill: $color; -fx-font-size: 10px; -fx-font-weight: bold;"
                        ...
                        onMouseEntered = EventHandler {
                            style = "-fx-background-color: $color; -fx-border-color: $color; -fx-border-radius: 100; -fx-border-width: 2; -fx-background-radius: 100; -fx-text-fill: #FFFFFF; -fx-font-size: 10px; -fx-font-weight: bold;"
                        }
    ...
    fun toast(title: String, body: Pane, color: String, time: Double, pos: Pos, width: Double)
    {
        Platform.runLater {
            ...
            toast.style   = "-fx-border-color: $color; -fx-border-width: 2px; -fx-background-color: #3c3f41; -fx-background-radius: 5px; -fx-border-radius: 5px; -fx-padding: 5px;"
    ...
    private fun doIfDontAlert(action: (() -> Unit))
    {
        if (this.children.contains(alert))
        {
            Thread {
                ...
                {
                    Platform.runLater {
                        alert.style = "-fx-border-color: White; -fx-border-width: 2px; -fx-background-color: #3c3f41; -fx-background-radius: 5px; -fx-border-radius: 5px; -fx-padding: 5px;"
                    }

                    Thread.sleep(100)

                    Platform.runLater {
                        alert.style = "-fx-border-color: Black; -fx-border-width: 2px; -fx-background-color: #3c3f41; -fx-background-radius: 5px; -fx-border-radius: 5px; -fx-padding: 5px;"
                    }
