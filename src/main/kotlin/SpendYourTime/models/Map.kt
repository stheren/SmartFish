...
{
    val _floor       = ArrayList<ArrayList<Int>>() // Contains the floor of the map (0 = empty, 1 2 3 4 = different types of floor)
    val _firstLayer  = ArrayList<ArrayList<Int>>() // Contains the first layer of the map (0 = empty, other = id of the object)
    val _secondLayer = ArrayList<ArrayList<Int>>() // Contains the second layer of the map (0 = empty, other = id of the object)
